...
public class PunishingBirdRenderer extends AbnormalityRenderer<PunishingBird> {
    ...
    @Override
    public void render(PunishingBird animatable, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
